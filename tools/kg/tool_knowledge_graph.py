"""
神经影像工具知识图谱 (NeuroImaging Tool Knowledge Graph)

参考 SciToolEval 论文的 SciToolKG 设计
目前没有加入主文件，就是为了写论文做的，RAG＋toolKG提高规划和工具调用的准确性
测试了一下，准确度加了2-3%

知识来源参考:
- NIH/PubMed 神经影像学文献 (2024-2025)
- FreeSurfer, FSL, SPM, DPABI 官方文档
- ENIGMA 联盟标准化流程
- Braak staging 和 神经退行性疾病分期研究
